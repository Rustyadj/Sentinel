...
-- Extend the existing production workspace table instead of creating a
-- competing neural_workspaces table.
...
-- AddForeignKey
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "neural_organizations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
